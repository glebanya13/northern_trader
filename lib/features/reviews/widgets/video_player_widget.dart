...
import 'video_player_widget_web_registry_stub.dart'
    if (dart.library.html) 'video_player_widget_web_registry.dart';
...
class _VideoPlayerWidgetState extends ConsumerState<VideoPlayerWidget> {
  ...
  void _registerWebView() {
    ...
    final kind = _videoType == VideoType.youtube
        ? 'youtube'
    ...
    registerVideoViewFactory(
      ...
      youtubeEmbedUrl:
          kind == 'youtube' ? _getYouTubeEmbedUrl(widget.videoUrl) : null,
      vimeoEmbedUrl: kind == 'vimeo' ? _getVimeoEmbedUrl(widget.videoUrl) : null,
    );
  }
